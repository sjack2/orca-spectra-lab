...
#   2b-crest-conf-search.sh --local --cpus 4 ephedrine
#   2b-crest-conf-search.sh --list mols.txt --dry-run
#
# Flags:
...
#
# Examples:
#   2b-crest-conf-search.sh --local --cpus 8 ephedrine
#   2b-crest-conf-search.sh --list molecules.txt --partition gpu
#   2b-crest-conf-search.sh --dry-run --local aspirin
#
# ============================================================================
